      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr auto", gap: 48, alignItems: "center", position: "relative" }}>
        <div>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" as const }}>
            <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" className="store-btn-light">
            ...
            <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" className="store-btn-dark">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3,20.5v-17c0-1.1.89-2,2-2l11,8.5-11,8.5C3.89,22.5,3,21.6,3,20.5z"/></svg>
              <div>
